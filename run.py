...
def main():
    print("==================================================")
    print("🚀 ĐANG KHỞI CHẠY HỆ THỐNG CHATBOT PHÁP LUẬT")
    print("==================================================")
    ...
    if not os.path.exists(venv_python):
        ...
        print("⚠️ Không tìm thấy môi trường ảo venv. Sử dụng Python hệ thống...")
    ...
    if is_port_in_use(8001):
        print("ℹ️ Cổng 8001 đã được sử dụng. Có thể server Backend đã chạy sẵn từ trước.")
    else:
        ...
        for _ in range(10):
            ...
            print("⚠️ Server khởi động lâu hơn dự kiến. Tiếp tục mở Frontend...")
    ...
    print("👉 Hãy đăng ký/đăng nhập tài khoản trên trình duyệt để bắt đầu chat.")
    print("👉 Nhấn tổ hợp phím Ctrl + C tại đây để dừng server.")
    print("==================================================\n")
    ...
    try:
        ...
        print("👋 Đã dừng toàn bộ hệ thống. Tạm biệt anh Lộc!")
